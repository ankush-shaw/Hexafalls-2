...
export function SupervisorNode({ data }: SupervisorNodeProps) {
  return (
    <div className="relative group p-4 rounded-3xl border-2 border-sky-500/50 bg-gradient-to-br from-card via-card to-sky-500/10 shadow-2xl backdrop-blur-xl min-w-[240px]">
      ...
      <div className="flex items-center justify-between pb-2 border-b border-border/40 text-xs">
        ...
        <span className="px-2 py-0.2 rounded-full text-[9px] font-bold uppercase tracking-wider bg-sky-500/20 text-sky-400 border border-sky-500/30">
          COO AI
        </span>
      </div>

      <div className="py-2.5 space-y-1 text-xs">
        <span className="text-[9px] font-bold uppercase tracking-wider text-muted-foreground">Operations Control</span>
      ...
      <div className="pt-2 border-t border-border/30 flex items-center justify-between text-[10px] font-mono text-muted-foreground">
        <span>Latency: <strong className="text-sky-400">{data.latencyMs}ms</strong></span>
