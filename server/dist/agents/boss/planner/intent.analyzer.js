...
exports.intentAnalyzer = exports.IntentAnalyzer = void 0;
class IntentAnalyzer {
    analyzeIntent(prompt, voiceTranscript) {
        const text = `${prompt} ${voiceTranscript || ''}`.toLowerCase();
        let requestType = 'analysis';
...
exports.intentAnalyzer = new IntentAnalyzer();
exports.default = exports.intentAnalyzer;
