import { ComplexityEstimation, ComplexityLevel, IntentAnalysis } from '../types/boss.types.js';

export class ComplexityEngine {
  public estimateComplexity(prompt: string, intent: IntentAnalysis): ComplexityEstimation {
...
export const complexityEngine = new ComplexityEngine();
