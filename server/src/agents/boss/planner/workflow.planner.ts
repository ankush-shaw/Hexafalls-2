import { DepartmentNode, WorkflowGraph, WorkflowStage, DependencyEdge, ExecutionStrategy } from '../types/boss.types.js';

export class WorkflowPlanner {
  public planGraph(departments: DepartmentNode[]): WorkflowGraph {
    ...
    const executionStrategy: ExecutionStrategy = 'mixed';
